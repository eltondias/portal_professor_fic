...
<link href="css/pagosenaopagos.css" rel="stylesheet" type="text/css" />
<style type="text/css">
#apDiv2 {
	position: absolute;
	left: 1004px;
...
include("include/conexao.php");
		 $sql = " select * from view_ficha_fin_web				 
				 where matric=".$matric." and ano=".$ano."							
			...
			echo  '<table align="center" class="cabecalho" width="50%" >
					<tr>
					  <th width="1%" class="cabecalho">Nome</th>
					  <td class=" cabecalho"scope="col" width="80%" >' .$nome. '</td>
					  <th width="1%" class="cabecalho"> Matricula </th>					  
     				  <td scope="col" width="3%" >'.$matric.'</td></table>';
				//criando a tabela das parcelas	
				echo'<br>
						  <table class=" table1" border="0"  align="center"   width="65%"  >
							<tr>
							  <th width="5%" scope="col">Ano/S</th>
...
//<div id="apDiv1"><img src="imagens/logo_esmac.png" width="189" height="82" />';
   ...
   echo '
  	  <width="65%" class=" table1" align="center"><tr><form method="post" action="boleto_santander_banespa.php">
	  ...
	  if($item==1  and $style=='aberta' and strtotime($hoje) <= strtotime($datven)){
