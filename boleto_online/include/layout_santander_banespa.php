...
de Impressão</DIV></TD><IMG SRC="../imagens/logo_empresa_mini.png"></TR><TR><TD valign=top class=cp><DIV ALIGN="left">
<p>
...
do Sacado</div></TD></tr></tbody></table><table width=666 cellspacing=5 cellpadding=0 border=0><tr><td width=41></TD></tr></table>
<!--<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
  <tr>
    <td width=41></td>
    <td class=ti width=455><?php echo $dadosboleto["identificacao"]; ?> <?php echo isset($dadosboleto[""]) ? "<p>".$dadosboleto["cpf_cnpj"] : '' ?><p>
	<?php echo $dadosboleto["endereco"]; ?><p>
...
<td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top  width=14 height=12><span class="campo">
...
<img height=13 src=imagens/1.png width=1 border=0></td><td class=ct valign=top width=123 height=13>Parcela</td><td class=ct valign=top height=13 width=7> 
