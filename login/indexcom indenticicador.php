    ...
    <table width="61%" height="230" border="0" align="center">
      ...
      <tr>
        ...
        <td width="83%"><span class="Style6">
          <label>
            <input name="login" style="text-align:left" type="text" id="login" value="a_aviz@yahoo.com.br" />
          </label>
        </span></td>
      </tr>
      <tr>
        ...
        <td><span class="Style6">
          <label>
            <input name="senha" style="text-align:left" type="password" id="senha" value="408444yv"  />
          </label>
        </span></td>
      </tr>
      <tr></tr>
      ...
      <tr>
        <td>&nbsp;</td>
        <td align="center"><img src="../captcha/captcha.php?l=170&a=50&tf=20&ql=6" width="150" height="40"></td><td><a class="" href="../form/index.php"></a>
      ...
      <tr>
        <td><span class="Style6">
          <p class="aluno">&nbsp;</p></td>
        <td><input name="palavra" style="text-align:left" type="text"  /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
