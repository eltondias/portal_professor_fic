...
<head>
  ...
  $(function() {
    ...
    <script src="../prg/jav/diario_tela.js"></script>
...
<div id="box1">
    ...
    <div id="content-right">   
     ...
     <div id="box2">
      <h3>Visualização/Impressão do Diário de Frequência</h3>
      <form name="falta_escolhe" style="margin-top:10px;" method="post" action="diario_frequencia_imp.php">
      <table>
      	<tr><td>
		...
		<br>
		<a href="diario_frequencia_imp.php"><a href="diario_frequencia_imp.php">
		<input name="bt_exibir" id="bt_exibir" type="submit" value="Exibir" />
		</a></a>
